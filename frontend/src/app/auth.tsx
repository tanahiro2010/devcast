  ...
  return (
    <section className="bg-[#f8f9fa]">
      <Center className="w-full h-screen px-4">
        ...
        >
          <Center className="h-auto space-y-6">

            <div className="text-center space-y-1">
              <Typography component="h1" sx={{ fontSize: 24, fontWeight: 500, color: "#202124" }}>
                DevCast にログイン
              </Typography>
            ...
            {error ? (
              <div className="w-full text-center space-y-4">
                <Typography sx={{ fontSize: 14, color: "#d93025" }}>
                  ログイン情報の取得に失敗しました。時間をおいて再度お試しください。
                </Typography>
              ...
              <a href={endpoint ?? "#"} className="w-full">
                <Button
                  variant="contained"
                  fullWidth
                  disableElevation
            ...
            <Typography sx={{ fontSize: 12, color: "#5f6368", textAlign: "center" }} className="space-y-2">
